export default {
  ...
  "be.add": "Lägg till",
  "be.appActivityAltIcon": "Ikon för {appActivityName}",
  "be.appActivityCreatedAtFullDateTime": "{time, date, full} vid {time, time, short}",
  "be.appActivityDeleteErrorMessage": "Ett fel inträffade när objektet skulle raderas.",
  "be.appActivityDeletePrompt": "Ta bort Appaktivitet?",
  ...
  "be.sidebarVersions.toggle": "Växla",
  ...
  "be.taskActionErrorTitle": "Fel",
  "be.taskApprove": "Slutför",
  "be.taskApproveErrorMessage": "Ett fel inträffade när uppgiften godkändes. Uppdatera sidan och försök igen.",
  "be.taskCollaboratorLoadErrorMessage": "An error has occurred while loading collaborators for this task. Please try again.",
  "be.taskCompleteErrorMessage": "Ett fel inträffade när uppgiften slutfördes. Uppdatera sidan och försök igen.",
  "be.taskCreateErrorMessage": "Ett fel uppstod när uppgiften skapades. Försök igen.",
  "be.taskCreateErrorTitle": "Fel",
  "be.taskDeleteErrorMessage": "Ett fel inträffade när uppgiften raderades. Uppdatera sidan och försök igen.",
  "be.taskDeleteMenuItem": "Radera uppgift",
  "be.taskDeletePrompt": "Vill du radera den här uppgiften permanent?",
  "be.taskDueDate": "Förfaller",
  "be.taskEditErrorMessage": "Ett fel uppstod när uppgiften ändrades. Försök igen.",
  "be.taskEditMenuItem": "Modifiera uppgiften",
  "be.taskReject": "Avvisa",
  "be.taskRejectErrorMessage": "Ett fel inträffade när uppgiften avvisades. Uppdatera sidan och försök igen.",
  ...
  "be.tasks.addTask.approval": "Godkännandeuppgift",
  "be.tasks.addTask.approval.description": "Begär ett godkännande för att flytta arbetet framåt",
  "be.tasks.addTask.general": "Allmän uppgift",
  "be.tasks.addTask.general.description": "Spåra arbete som behöver utföras",
  "be.tasks.addTaskForm.cancel": "Avbryt",
  "be.tasks.addTaskForm.dueDateLabel": "Förfallodatum",
  "be.tasks.addTaskForm.messageLabel": "Meddelande",
  "be.tasks.addTaskForm.selectAssigneesLabel": "Välj tilldelade",
  "be.tasks.addTaskForm.submit": "Skapa",
  "be.tasks.createTask.approval.title": "Skapa godkännandeuppgift",
  "be.tasks.createTask.general.title": "Skapa allmän uppgift",
  "be.tasks.editTask.approval.title": "Ändra godkännandeuppgift",
  "be.tasks.editTask.general.title": "Ändra allmän uppgift",
  "be.tasks.editTaskForm.submit": "Uppdatera",
  "be.tasks.feed.approveAction": "Godkänn",
  "be.tasks.feed.approvedLabel": "Godkänt",
  "be.tasks.feed.assigneeList.title": "Delegerade",
  "be.tasks.feed.completeAction": "Markera som slutförd",
  "be.tasks.feed.completedLabel": "Klart",
  "be.tasks.feed.headline.approval": "{user} tilldelade en godkännandeuppgift",
  "be.tasks.feed.headline.approval.currentUser": "{user} har tilldelat dig en godkännandeuppgift",
  "be.tasks.feed.headline.general": "{user} tilldelade en uppgift",
  "be.tasks.feed.headline.general.currentUser": "{user} har tilldelat dig en uppgift",
  "be.tasks.feed.inProgressLabel": "Pågår",
  "be.tasks.feed.moreAssigneesLabel": "Se alla tilldelade",
  "be.tasks.feed.rejectAction": "Avvisa",
  "be.tasks.feed.rejectedLabel": "Avvisat",
  "be.tasks.feed.statusLabel": "Status: {taskStatus}",
  "be.tasks.status.approved": "Godkänd {dateTime}",
  "be.tasks.status.completed": "Klart {dateTime}",
  "be.tasks.status.inProgress": "Väntande",
  "be.tasks.status.notStarted": "Väntande",
  "be.tasks.status.rejected": "Avvisat {dateTime}",
  "be.tasks.taskDueDate": "Förfaller: {date}",
  ...
  "boxui.classification.addClassification": "Lägg till klassificering",
  ...
  "boxui.metadataView.needRefiningHeaderText": "För många resultat",
  "boxui.metadataView.needRefiningSubtitleText": "Använd filter för att begränsa sökresultaten.",
  "boxui.metadataView.noResultsForQueryHeaderText": "Inga resultat",
  "boxui.metadataView.noResultsForQuerySubtitleText": "Du har inte åtkomst till några filer som matchar din sökning. Använd filter för att ändra sökningen.",
  "boxui.metadataView.noResultsForTemplateHeaderText": "Inga resultat",
  "boxui.metadataView.noResultsForTemplateSubtitleText": "Du har inte åtkomst till några filer som matchar den här mallen.",
  "boxui.metadataView.tooManyResultsHeaderText": "Över {upperFileLimit} filer matchar den här mallen",
  "boxui.metadataView.tooManyResultsSubtitleText": "Resultatuppsättningar av den här storleken stöds för närvarande inte i Box.",
