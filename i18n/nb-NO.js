export default {
  ...
  "be.add": "Legg til",
  "be.appActivityAltIcon": "{appActivityName}-ikon",
  "be.appActivityCreatedAtFullDateTime": "{time, date, full} kl. {time, time, short}",
  "be.appActivityDeleteErrorMessage": "Det oppstod en feil med å slette dette elementet.",
  "be.appActivityDeletePrompt": "Vil du slette appaktiviteten?",
  ...
  "be.commentCreateConflictMessage": "Denne kommentaren finnes allerede.",
  "be.commentCreateErrorMessage": "Det oppstod en feil med å opprette denne kommentaren.",
  "be.commentDeleteErrorMessage": "Det oppstod en feil med å slette denne kommentaren.",
  ...
  "be.in": "I",
  "be.inlineDeleteCancel": "Nei",
  "be.inlineDeleteConfirm": "Ja",
  ...
  "be.sidebarVersions.toggle": "Aktiver/deaktiver",
  ...
  "be.taskActionErrorTitle": "Feil",
  "be.taskApprove": "Fullfør",
  "be.taskApproveErrorMessage": "Det oppsto en feil ved godkjenningen av denne oppgaven. Last inn siden på nytt, og prøv igjen.",
  "be.taskCollaboratorLoadErrorMessage": "An error has occurred while loading collaborators for this task. Please try again.",
  "be.taskCompleteErrorMessage": "Det oppsto en feil ved gjennomføringen av denne oppgaven. Last inn siden på nytt, og prøv igjen.",
  "be.taskCreateErrorMessage": "Det oppsto en feil da du opprettet denne oppgaven. Prøv igjen.",
  "be.taskCreateErrorTitle": "Feil",
  "be.taskDeleteErrorMessage": "Kan ikke slette denne oppgaven. Last inn siden på nytt, og prøv igjen.",
  "be.taskDeleteMenuItem": "Slett oppgave",
  "be.taskDeletePrompt": "Er du sikker på at du vil slette denne oppgaven for godt?",
  "be.taskDueDate": "Forfaller",
  "be.taskEditErrorMessage": "Det oppsto en feil da du endret denne oppgaven. Prøv igjen.",
  "be.taskEditMenuItem": "Endre oppgave",
  "be.taskReject": "Avslå",
  "be.taskRejectErrorMessage": "Det oppsto en feil ved avvisningen av denne oppgaven. Last inn siden på nytt, og prøv igjen.",
  "be.taskShowLessAssignees": "Show Less",
  "be.taskShowMoreAssignees": "Show {additionalAssigneeCount} More",
  "be.tasks.addTask": "Legg til oppgave",
  "be.tasks.addTask.approval": "Godkjenningsoppgave",
  "be.tasks.addTask.approval.description": "Be om en godkjenning for å flytte arbeidet fremover",
  "be.tasks.addTask.general": "Generell oppgave",
  "be.tasks.addTask.general.description": "Hold oversikt over oppgaver som må utføres",
  "be.tasks.addTaskForm.cancel": "Avbryt",
  "be.tasks.addTaskForm.dueDateLabel": "Forfallsdato",
  "be.tasks.addTaskForm.messageLabel": "Melding",
  "be.tasks.addTaskForm.selectAssigneesLabel": "Velg ansvarlige",
  "be.tasks.addTaskForm.submit": "Opprett",
  "be.tasks.createTask.approval.title": "Opprett en godkjenningsoppgave",
  "be.tasks.createTask.general.title": "Opprett en generell oppgave",
  "be.tasks.editTask.approval.title": "Endre godkjenningsoppgave",
  "be.tasks.editTask.general.title": "Endre generell oppgave",
  "be.tasks.editTaskForm.submit": "Oppdater",
  "be.tasks.feed.approveAction": "Godkjenn",
  "be.tasks.feed.approvedLabel": "Godkjent",
  "be.tasks.feed.assigneeList.title": "Ansvarlige",
  "be.tasks.feed.completeAction": "Merk som fullført",
  "be.tasks.feed.completedLabel": "Fullført",
  "be.tasks.feed.headline.approval": "{user} tilordnet en godkjenningsoppgave",
  "be.tasks.feed.headline.approval.currentUser": "{user} tilordnet deg en godkjenningsoppgave",
  "be.tasks.feed.headline.general": "{user} tilordnet en oppgave",
  "be.tasks.feed.headline.general.currentUser": "{user} tilordnet deg en oppgave",
  "be.tasks.feed.inProgressLabel": "Pågår",
  "be.tasks.feed.moreAssigneesLabel": "Se alle ansvarlige",
  "be.tasks.feed.rejectAction": "Avvis",
  "be.tasks.feed.rejectedLabel": "Avvist",
  "be.tasks.feed.statusLabel": "Status: {taskStatus}",
  "be.tasks.status.approved": "Godkjent {dateTime}",
  "be.tasks.status.completed": "Fullført {dateTime}",
  "be.tasks.status.inProgress": "Venter",
  "be.tasks.status.notStarted": "Venter",
  "be.tasks.status.rejected": "Avvist {dateTime}",
  "be.tasks.taskDueDate": "Forfaller: {date}",
  ...
  "boxui.classification.addClassification": "Legg til klassifisering",
  ...
  "boxui.metadataView.needRefiningSubtitleText": "Bruk filtre til å begrense resultatene.",
  "boxui.metadataView.noResultsForQueryHeaderText": "Ingen resultater",
  "boxui.metadataView.noResultsForQuerySubtitleText": "Du har ikke tilgang til noen av filene som samsvarer med søket ditt. Bruk filtre til å endre søket.",
  "boxui.metadataView.noResultsForTemplateHeaderText": "Ingen resultater",
  "boxui.metadataView.noResultsForTemplateSubtitleText": "Du har ikke tilgang til noen av filene som samsvarer med denne malen.",
  "boxui.metadataView.tooManyResultsHeaderText": "Mer enn {upperFileLimit} filer samsvarer med denne malen",
  "boxui.metadataView.tooManyResultsSubtitleText": "Resultatsett av denne størrelsen støttes foreløpig ikke i Box.",
