export default {
  ...
  "be.add": "Add",
  "be.appActivityAltIcon": "{appActivityName} Icon",
  "be.appActivityCreatedAtFullDateTime": "{time, date, full} at {time, time, short}",
  "be.appActivityDeleteErrorMessage": "There was an error deleting this item.",
  "be.appActivityDeletePrompt": "Delete App Activity?",
  ...
  "be.taskCreateErrorMessage": "An error occurred while creating this task. Please try again.",
  "be.taskCreateErrorTitle": "Error",
  "be.taskDeleteErrorMessage": "There was an error while deleting this task. Please refresh the page and try again.",
  "be.taskDeleteMenuItem": "Delete task",
  "be.taskDeletePrompt": "Are you sure you want to permanently delete this task?",
  "be.taskDueDate": "Due",
  "be.taskEditErrorMessage": "An error occurred while modifying this task. Please try again.",
  "be.taskEditMenuItem": "Modify task",
  ...
  "be.tasks.addTask.approval": "Approval Task",
  "be.tasks.addTask.approval.description": "Request an approval to move work forward",
  "be.tasks.addTask.general": "General Task",
  "be.tasks.addTask.general.description": "Keep track of work that needs to get done",
  ...
  "be.tasks.feed.approvedLabel": "Approved",
  "be.tasks.feed.assigneeList.title": "Assignees",
  "be.tasks.feed.completeAction": "Mark as Complete",
  "be.tasks.feed.completedLabel": "Completed",
  "be.tasks.feed.headline.approval": "{user} assigned an Approval Task",
  "be.tasks.feed.headline.approval.currentUser": "{user} assigned you an Approval Task",
  "be.tasks.feed.headline.general": "{user} assigned a Task",
  ...
  "be.tasks.feed.rejectedLabel": "Rejected",
