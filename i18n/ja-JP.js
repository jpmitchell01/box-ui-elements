export default {
  ...
  "be.add": "追加",
  "be.appActivityAltIcon": "{appActivityName}アイコン",
  "be.appActivityCreatedAtFullDateTime": "{time, date, full}、{time, time, short}",
  "be.appActivityDeleteErrorMessage": "この項目の削除中にエラーが発生しました。",
  "be.appActivityDeletePrompt": "アプリアクティビティを削除しますか?",
  ...
  "be.in": "検索するフォルダ:",
  "be.inlineDeleteCancel": "いいえ",
  "be.inlineDeleteConfirm": "はい",
  ...
  "be.sidebarVersions.toggle": "切り替え",
  ...
  "be.taskActionErrorTitle": "エラー",
  "be.taskApprove": "完了",
  "be.taskApproveErrorMessage": "このタスクの承認中にエラーが発生しました。ページを更新して、もう一度やり直してください。",
  "be.taskCollaboratorLoadErrorMessage": "An error has occurred while loading collaborators for this task. Please try again.",
  "be.taskCompleteErrorMessage": "このタスクの完了中にエラーが発生しました。ページを更新して、もう一度やり直してください。",
  "be.taskCreateErrorMessage": "このタスクの作成中にエラーが発生しました。もう一度やり直してください。",
  "be.taskCreateErrorTitle": "エラー",
  "be.taskDeleteErrorMessage": "このタスクの削除中にエラーが発生しました。ページを更新して、もう一度やり直してください。",
  "be.taskDeleteMenuItem": "タスクを削除",
  "be.taskDeletePrompt": "このタスクを完全に削除してもよろしいですか?",
  "be.taskDueDate": "期日",
  "be.taskEditErrorMessage": "このタスクの変更中にエラーが発生しました。もう一度やり直してください。",
  "be.taskEditMenuItem": "タスクを変更",
  "be.taskReject": "拒否",
  "be.taskRejectErrorMessage": "このタスクの拒否中にエラーが発生しました。ページを更新して、もう一度やり直してください。",
  "be.taskShowLessAssignees": "Show Less",
  "be.taskShowMoreAssignees": "Show {additionalAssigneeCount} More",
  "be.tasks.addTask": "タスクを追加",
  "be.tasks.addTask.approval": "承認タスク",
  "be.tasks.addTask.approval.description": "作業を進めるための承認を要求します",
  "be.tasks.addTask.general": "一般タスク",
  "be.tasks.addTask.general.description": "完了する必要のある作業を追跡します",
  "be.tasks.addTaskForm.cancel": "キャンセル",
  "be.tasks.addTaskForm.dueDateLabel": "期日",
  "be.tasks.addTaskForm.messageLabel": "メッセージ",
  "be.tasks.addTaskForm.selectAssigneesLabel": "担当者の選択",
  "be.tasks.addTaskForm.submit": "作成",
  "be.tasks.createTask.approval.title": "承認タスクの作成",
  "be.tasks.createTask.general.title": "一般タスクの作成",
  "be.tasks.editTask.approval.title": "承認タスクを変更",
  "be.tasks.editTask.general.title": "一般タスクを変更",
  "be.tasks.editTaskForm.submit": "更新",
  "be.tasks.feed.approveAction": "承認",
  "be.tasks.feed.approvedLabel": "承認済み",
  "be.tasks.feed.assigneeList.title": "タスク担当者",
  "be.tasks.feed.completeAction": "完了としてマーク",
  "be.tasks.feed.completedLabel": "完了済み",
  "be.tasks.feed.headline.approval": "{user}が承認タスクを割り当てました",
  "be.tasks.feed.headline.approval.currentUser": "{user}があなたに承認タスクを割り当てました",
  "be.tasks.feed.headline.general": "{user}がタスクを割り当てました",
  "be.tasks.feed.headline.general.currentUser": "{user}があなたにタスクを割り当てました",
  "be.tasks.feed.inProgressLabel": "進行中",
  "be.tasks.feed.moreAssigneesLabel": "すべての担当者を表示",
  "be.tasks.feed.rejectAction": "拒否",
  "be.tasks.feed.rejectedLabel": "拒否済み",
  "be.tasks.feed.statusLabel": "ステータス: {taskStatus}",
  "be.tasks.status.approved": "{dateTime}に承認しました",
  "be.tasks.status.completed": "{dateTime}に完了しました",
  "be.tasks.status.inProgress": "待機中",
  "be.tasks.status.notStarted": "待機中",
  "be.tasks.status.rejected": "{dateTime}に拒否しました",
  "be.tasks.taskDueDate": "期限: {date}",
  ...
  "boxui.metadataView.tooManyResultsHeaderText": "{upperFileLimit}個を超えるファイルがこのテンプレートに一致します",
