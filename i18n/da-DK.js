export default {
  ...
  "be.appActivityDeleteErrorMessage": "Der opstod en fejl under sletning af dette element.",
  "be.appActivityDeletePrompt": "Slet appaktivitet?",
  ...
  "be.sidebarVersions.toggle": "Skift",
  ...
  "be.taskActionErrorTitle": "Fejl",
  "be.taskApprove": "Fuldfør",
  "be.taskApproveErrorMessage": "Der opstod en fejl under godkendelse af denne opgave. Opdater siden, og prøv igen.",
  "be.taskCollaboratorLoadErrorMessage": "An error has occurred while loading collaborators for this task. Please try again.",
  "be.taskCompleteErrorMessage": "Der opstod en fejl under fuldførelse af denne opgave. Opdater siden, og prøv igen.",
  "be.taskCreateErrorMessage": "Der opstod en fejl under oprettelse af denne opgave. Prøv igen.",
  "be.taskCreateErrorTitle": "Fejl",
  "be.taskDeleteErrorMessage": "Der opstod en fejl under sletning af denne opgave. Opdater siden, og prøv igen.",
  "be.taskDeleteMenuItem": "Slet opgave",
  "be.taskDeletePrompt": "Er du sikker på, at du vil slette denne opgave permanent?",
  "be.taskDueDate": "Deadline",
  "be.taskEditErrorMessage": "Der opstod en fejl under redigering af denne opgave. Prøv igen.",
  "be.taskEditMenuItem": "Rediger opgave",
  "be.taskReject": "Afvis",
  "be.taskRejectErrorMessage": "Der opstod en fejl under afvisningen af denne opgave. Opdater siden, og prøv igen.",
  ...
  "be.tasks.addTask.approval": "Godkendelsesopgave",
  "be.tasks.addTask.approval.description": "Anmod om godkendelse til at fortsætte arbejdet",
  "be.tasks.addTask.general": "Generel opgave",
  "be.tasks.addTask.general.description": "Hold styr på det arbejde, der skal laves",
  ...
  "be.tasks.addTaskForm.selectAssigneesLabel": "Vælg modtagere",
  "be.tasks.addTaskForm.submit": "Opret",
  "be.tasks.createTask.approval.title": "Opret en godkendelsesopgave",
  "be.tasks.createTask.general.title": "Opret en generel opgave",
  "be.tasks.editTask.approval.title": "Rediger godkendelsesopgave",
  "be.tasks.editTask.general.title": "Rediger generel opgave",
  "be.tasks.editTaskForm.submit": "Opdatering",
  "be.tasks.feed.approveAction": "Godkend",
  "be.tasks.feed.approvedLabel": "Godkendt",
  "be.tasks.feed.assigneeList.title": "Opgavemodtagere",
  "be.tasks.feed.completeAction": "Markér som fuldført",
  "be.tasks.feed.completedLabel": "Fuldført",
  "be.tasks.feed.headline.approval": "{user} tildelte en godkendelsesopgave",
  "be.tasks.feed.headline.approval.currentUser": "{user} tildelte dig en godkendelsesopgave",
  "be.tasks.feed.headline.general": "{user} tildelte en opgave",
  "be.tasks.feed.headline.general.currentUser": "{user} tildelte dig en opgave",
  "be.tasks.feed.inProgressLabel": "I gang",
  "be.tasks.feed.moreAssigneesLabel": "Se alle opgavemodtagere",
  "be.tasks.feed.rejectAction": "Afvis",
  "be.tasks.feed.rejectedLabel": "Afvist",
  "be.tasks.feed.statusLabel": "Status: {taskStatus}",
  "be.tasks.status.approved": "Godkendt {dateTime}",
  "be.tasks.status.completed": "Fuldført {dateTime}",
  "be.tasks.status.inProgress": "Afventer",
  "be.tasks.status.notStarted": "Afventer",
  "be.tasks.status.rejected": "Afvist {dateTime}",
  "be.tasks.taskDueDate": "Forfalder: {date}",
